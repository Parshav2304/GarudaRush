...
def dashboard_info():
    """Return available dashboard endpoints"""
    return jsonify({
        'message': 'GarudaRush Dashboard API',
        'endpoints': {
            'overview': '/api/dashboard/overview',
            'real-time-metrics': '/api/dashboard/real-time-metrics',
            'agent-status': '/api/dashboard/agent-status',
            'network-topology': '/api/dashboard/network-topology'
        }
    }), 200
